...
const INITIAL_MISSIONS: Mission[] = [
  {
    ...
    description: "Take a clear photo of your field soil for analysis.",
    xpReward: 50,
    completed: false,
    icon: "📸",
  },
  {
    ...
    description: "View today's mandi rates for your crops.",
    xpReward: 20,
    completed: false,
    icon: "ww",
  },
  {
    id: "m3",
    title: "Listen to Weather Alert",
    description: "Check the local forecast for the next 3 days.",
    xpReward: 30,
    completed: false,
    icon: "🌦️",
  },
